# Authorization (/docs/api-reference/authorization)
...
1\. Enable the API [#1-enable-the-api]
...
2\. Create an API Token [#2-create-an-api-token]
...
Configure Allowed IPs [#configure-allowed-ips]
